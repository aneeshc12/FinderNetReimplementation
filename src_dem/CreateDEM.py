...
PCDPathList = [
    '/scratch/aneesh.chavan/KITTI_raw/09/velodyne/001579.bin',
    '/scratch/aneesh.chavan/KITTI_raw/09/velodyne/000579.bin',
    '/scratch/aneesh.chavan/KITTI_raw/09/velodyne/000079.bin',
]

DC.CreateDEM(PCDPathList , "/home2/aneesh.chavan/FinderNetReimplementation/src_dem", './aug.txt')